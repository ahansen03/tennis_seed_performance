...
The inspiration for this project comes from my experiences growing up as a tennis player and an avid follower of professional tennis. The sentiment “the WTA [women’s] tour is inconsistent compared to the ATP [men’s] tour” is often shared, and heard primarily after every surprise loss in the WTA tour. This is usually followed up discourse around the difference between women and men physically and emotionally, but I was more interested in quantifying the differences to examine the validity of the base claim while simultaneously discovering some factors that influence this perception. An important goal of this project is to examine differences between ATP and WTA tour seed performances in order to begin to address claims about the inconsistency about the WTA, as well as to inform conversations around the topic of changing the WTA Grand Slam match format to best-of-five rather than best-of-three.
...
After collecting that data, I wanted to create a boolean column that represents whether or not an observation was considered an “upset”. The first part of this was removing seeds which, based on my experiences following tennis, had such expectations that an upset was possible in the first place. This is because even if a seeded player loses to an unseeded player, this doesn’t necessarily fit the requirements of an upset. Upon doing this, I created the following criteria for an upset: a player in a tournament was upset if they were more than 2 wins away from reaching their expected rounds won based on their adjusted seed value. Python data filtering and expansion scripts in Google Colaboratory [here](https://colab.research.google.com/drive/1GCSkMTTcY_qCbacul9bb1TSKv7E0boAz?usp=sharing). All of the steps I am glossing over here are covered in full in the Colaboratory. 
